    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <h2>Create new password</h2>
          ...
          <div class="col-lg-10">
            <form action="forms/resetpass.php" method="POST" role="form" enctype="multipart/form-data" class="php-email-form">
            	<?php
              ...
              <div class="row">
               ...
               <div class="col-md-6 form-group">
                ...
                $preset_on = $_GET['preset_on'];
                ?>
                
                  <input type="hidden" name="myid" class="form-control" id="email" placeholder="Enter your username" required value = "<?php echo $myid;?>">
               
               
              
                 <input class="form-control" type="hidden" name="username" placeholder="Password" required
                 value = "<?php echo $username;?>">
              
             
                 <input class="form-control" type="hidden" name="preset_on" placeholder="Password" required 
                 value = "<?php echo $preset_on;?>">
              ...
              <div class="row"> 
              <div class="col-md-12 form-group mt-3">
                 <input class="form-control" type="password" name="pass2" placeholder="Confirm new assword" required>
              </div>

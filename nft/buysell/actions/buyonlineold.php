...
if(isset($_POST['submit'])){
   $mytotal =  $mynft + ($unit*2);
        ...
        exit(); 
            ...
            $sql ="SELECT * FROM quantumnft_quantum.market Where id ='$id'";
                        ...
                        if ($result-> num_rows >0) {
                            ...
                            if ($cunit >= $unit) {
                                $query = "UPDATE quantumnft_quantum.market SET unit = (unit-'$unit'),status = 1 WHERE id = '$id';
                                UPDATE quantumnft_quantum.applicants SET nftwaiting =(nftwaiting+'$unit'),paystatus = '1'  WHERE username = '$userid';
                                 INSERT INTO quantumnft_quantum.buyers(userid,tranid,buyername,phone,sellerid,coin,unit,amount,buyerwaddress,sellerwaddress,boughtdate) 
                                 VALUES('$userid','$id','$buyername','$bphone', '$sellerid','$coin','$unit','$amount','$buyerwaddress','$sellerwaddress',current_timestamp)";

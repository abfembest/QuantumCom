        ...
        <div class="row">
            ...
            <form method = "POST" action = "actions/cancelbuy.php">
                <?php include "db_connect.php";
                  ...
                  <input type = "hidde" value = "<?php echo $row['buyerwaddress'];?>"  readonly>
                  ...
                  <button type="submit" class="btn btn-danger col-lg-8 text-center fw-bolder" name="cancelu" >Cancel order</button>                  
                </div>
                </div>
              </div>
                                </div>

...
if ($result-> num_rows >0) {
  ...
  $final =strtotime(date("Y/m/d h:i:s "));   
  $start = strtotime(date($rentconfirmdate));
  $rentdays = ceil((($final-$start)/86400));
                      ...
                      <div class="card card-info">
                        ...
                        <div class="card-body p-3 bg-info">
                            ...
                            <div class="card-body mb-4">
                              ...
                              <div class="row justify-content-center">
                                <p class= "h5 m-4 w-bold"><b>NFT will mature in less than 24 hours</b></p>
                        </div>
                      </div>
                      </div>' ;
            ...
            <div class="col-lg-8"  style="border-top:20px solid red;">
                <div class="row">
                  ...
                  if($level<25){
                    ...
                    echo'<label><b>Quantity</b></label>&nbsp&nbsp&nbsp<label>Buyer/seller level</label>
                    ...
                    echo'<label><b>Quantity</b></label>&nbsp&nbsp&nbsp<label>Retailer level</label>
                    <input type="number" class="form-control" placeholder="quantity" oninput = "display()" 
                    required ="required" id = "data" name="unit" min ="1" max="4">';
                  }elseif($level>=50 && $level<100){
                    echo'<label><b>Quantity</b></label>&nbsp&nbsp&nbsp<label>Wholesaler level</label>
                  ...
                  elseif($level>=100 && $level<150){
                    echo'<label><b>Quantity</b></label>&nbsp&nbsp&nbsp<label>Merchant level</label>
                    <input type="number" required class="form-control" placeholder="Quantity" oninput = "display() required ="required" "id="data" name="unit" min ="1" max="8">';
                  }
                  elseif($level>=150 && $level<200){
                    echo'<label><b>Quantity</b></label>
                    <input type="number" required class="form-control" placeholder="Quantity" oninput = "display()"  id="data" name="unit" min ="1" max="10">';
                  }
                  elseif($level>=200){
                    echo'<label><b>Quantity</b></label>&nbsp&nbsp&nbsp<label>Producer level</label>
                    <input type="number" class="form-control" placeholder="Quantity" required ="required" oninput = "display()" id = "data" name="unit" min ="1" max="12">';
                  }
                  ?>
                    <br>

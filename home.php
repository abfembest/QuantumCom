    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <h2>Sign in to trade</h2>
          ...
          <div class="col-lg-10">
            <form action="action_login.php" method="POST" role="form" enctype="multipart/form-data" class="php-email-form">
            	<?php
              ...
              <div class="row">
               ...
               <div class="col-md-6 form-group">
                ...
                <div class="col-md-12 form-group">
                  <input type="text" name="myid" class="form-control" id="email" placeholder="Enter your username" required>
                </div>
              ...
              <div class="text-center"><button type="submit" name="submit">Login</button>
              or <a href  = "forgot_pass.php">Reset password</a>
            </div>
            </form>
          </div>
